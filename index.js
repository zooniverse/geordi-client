  ...
  module.exports = GeordiClient = (function() {
    ...
    GeordiClient.prototype.updateEventDataFromParameterObject = function(parameterObject, eventData) {
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        field = ref[i];
        if (indexOf.call(parameterObject, field) >= 0 && typeof parameterObject[field] === "string" && parameterObject[field].length > 0) {
          eventData[field] = parameterObject[field];
        }
      }
      if (indexOf.call(parameterObject, "data") >= 0 && typeof parameterObject["data"] === "object") {
        eventData["data"] = JSON.stringify(parameterObject["data"]);
      }
      if (indexOf.call(parameterObject, "browserTime") >= 0 && typeof parameterObject["browserTime"] === "number" && parameterObject["browserTime"] > 1441062000000) {
