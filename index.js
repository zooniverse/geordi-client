...
(function() {
  var DummyExperimentServerClient, ExperimentServerClient, GeordiClient, ZooUserStringGetter,
  ...
  DummyExperimentServerClient = ExperimentServerClient = (function() {
    function ExperimentServerClient() {}

    ExperimentServerClient.prototype.currentCohort = null;

    ExperimentServerClient.prototype.ACTIVE_EXPERIMENT = null;

    ExperimentServerClient.prototype.getCohort = function() {
      var eventualCohort;
      eventualCohort = new $.Deferred();
      eventualCohort.then(function() {
        return eventualCohort.resolve(null);
      });
      return eventualCohort.promise();
    };

    return ExperimentServerClient;
  ...
  module.exports = GeordiClient = (function() {
    ...
    GeordiClient.prototype.defaultExperimentServerClient = new DummyExperimentServerClient();
    ...
    function GeordiClient(config) {
      ...
      if (!"experimentServerClient" in config) {
        config["experimentServerClient"] = this.defaultExperimentServerClient;
      }
    ...
    GeordiClient.prototype.logEvent = function(type, related_id, subject_id) {
      ...
      return this.addUserDetailsToEventData(eventData).always((function(_this) {
        return function(eventData) {
          if (_this.experimentServerClient.ACTIVE_EXPERIMENT === null || (_this.experimentServerClient.currentCohort != null)) {
